...
if __name__=='__main__':
    ...
    parser.add_argument('--pre_epochs', type=int, default=150, help='# of pre-training epochs')
    parser.add_argument('--fine_epochs', type=int, default=100, help='# of fine-tuning epochs')
